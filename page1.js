// page1.js
// หน้า 1: ฟอร์ม + ปุ่มบันทึก + เขียนเข้า window.drugAllergyData
...
function initPage1() {
  ...
  root.innerHTML = `
    <div style="max-width:820px; background:white; padding:1rem 1.2rem; border-radius:.75rem; box-shadow:0 2px 10px rgba(0,0,0,.05);">
      ...
      <!-- อาการคัน (เปลี่ยนเป็นสี่เหลี่ยม) -->
  ...
  // ✅ ผูกปุ่มตรงนี้ (สำคัญสุด)
  const btn = document.getElementById("p1-save");
  if (btn) {
    btn.addEventListener("click", savePage1);
  }

  // กันเลือก "บวม" กับ "ไม่บวม" พร้อมกัน
...
function savePage1(e) {
  // กันบาง browser ที่คิดว่านี่คือ submit form
